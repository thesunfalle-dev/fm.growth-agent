...
**Related:** `shared-blocks.md` (**what crypto / indices already share**), `pattern-catalog.md` (**register patterns here** when screens arrive), `homepage-patterns.md`, `block-inventory.json`, `landing-patterns.md`, `sections.md`, `tables.md`, `cards.md`.
...
|--------------------|-----------------|-----------|
| “Our / here’s our / tight spreads” | [Here’s Our Spreads `29987:341476`](https://www.figma.com/design/5PQJiXq7xZNGCqV1XNvKro/Website-Redesign-FM-2.0?node-id=29987-341476) tabs + TV_Card rail | `spread-cards` — **not** invent a different table layout |
