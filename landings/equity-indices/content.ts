...
const landing: LandingDocument = {
  ...
  blocks: [
    ...
    },
    {
      ...
      subtitle: "Get started live or get a free demo.",
      primaryCta: { label: "Get a live account", href: "https://hub.fusionmarkets.com/auth/sign-up" },
      secondaryCta: { label: "Try a free demo", href: "https://hub.fusionmarkets.com/auth/sign-up" },
    },
